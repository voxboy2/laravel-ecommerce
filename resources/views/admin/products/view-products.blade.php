            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
               ...
               @endif 
                  ...
                  <td class="center">
                    <a href="#myModal{{ $product->id }}" data-toggle="modal" class="btn btn-warning btn-mini">View Popup</a> 
                  <a href="{{ url('/admin/edit-product',$product->id) }}" class="btn btn-success btn-mini">Edit</a>
                  <a href="{{ url('/admin/add-attributes',$product->id) }}" class="btn btn-primary btn-mini">Add Attributes</a>
