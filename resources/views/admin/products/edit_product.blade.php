...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">Edit product</a> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <div class="control-group">
              ...
              <div class="control-group">
                <label class="control-label">Featured Items</label>
                <div class="controls">
                  <input type="checkbox" name="featured_products" id="featured_products" @if($productDetails->featured_products=="1") checked @endif value="1">
                </div>
              </div>
